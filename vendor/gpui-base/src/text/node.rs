    ...
    fn render_list_item_row(
        ...
        h_flex()
            ...
            .when(!options.todo && checked.is_none(), |this| {
                // Nexus: the prefix already ends with a space; the gap adds the
                // separation between the marker and the item's text.
                this.gap(rems(0.25))
    ...
    pub(crate) fn render_block(
        ...
        match self {
            ...
            BlockNode::List {
                ...
                .min_w_0()
                .pb(mb)
                // Nexus: indent lists off the paragraph column and give items
                // breathing room, so markers do not read as flush body text.
                .pl(rems(1.4))
                .gap(rems(0.375))
                .children({
